...
<div id="page-content-wrapper">
      ...
      <div class="collapse navbar-collapse show" id="navbarSupportedContent">
        <ul class="navbar-nav dashboard-nav">
          <li class="nav-item active">
            <li class="nav-item active"><a class="nav-link" href="{{url('distribution/listing',$vq->id)}}"> <img src="{{ asset('admin/images/back.svg')}}"> {{$vq->hospital_name}} Activity Tracker</a></li>
          </li>
        </ul>
  ...
  <ul class="bradecram-menu">
    <li>
      <a href="{{url('distribution/dashboard')}}"> Home </a>
    </li>
    <li>
      <a href="{{url('distribution/listing')}}"> VQ Request Listing </a>
    </li>
    <li>
      <a href="{{url('distribution/listing',$vq->id)}}"> VQ Request Details </a>
    </li>
    <li class="">
      <a href="{{url('distribution/listing',$vq->id)}}">
        {{$vq->hospital_name}}
      </a>
    </li>	
	<li class="active">
    ...
    <div class="row">
      ...
      <script type="text/javascript">
        ...
        $('#activity_filter').on('change', function(){
          var settings = {
            "url": "/distribution/activity_filter",
            "method": "POST",
            "timeout": 0,
            "headers": {
