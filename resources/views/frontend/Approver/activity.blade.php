...
<div id="page-content-wrapper">
      ...
      <div class="collapse navbar-collapse show" id="navbarSupportedContent">
        <ul class="navbar-nav dashboard-nav">
          <li class="nav-item active">
            <li class="nav-item active"><a class="nav-link" href="{{url('approver/listing',$vq->id)}}"> <img src="{{ asset('admin/images/back.svg')}}"> {{$vq->hospital_name}} Activity Tracker</a></li>
          </li>
        </ul>
 ...
 @if(Session::get('type')=='approver')
  <ul class="bradecram-menu">
    <li>
      <a href="{{url('approver')}}"> Home </a>
    </li>
    <li>
      <a href="{{url('approver/listing')}}"> VQ Request Listing </a>
    </li>
    <li>
      <a href="{{url('approver/listing',$vq->id)}}"> VQ Request Details </a>
    </li>
    <li class="active">
      <a href="">
        Activity Tracker
  ...
  <ul class="bradecram-menu">
    ...
    <li>
      <a href="{{url('approver/request_listing')}}"> VQ Request Listing </a>
    </li>
    <li class="active">
      <a href="">
        Activity Tracker
      ...
      <div class="col">
        <div class="actions-dashboard">
          ...
          <div class="filter_section  float-right1">
            ...
            <select name="activity_type" class="js-example-basic-single" id="activity_filter" multiple="">
          ...
          <div class="activity-tracker">
            <ul id="myList">
              <?php //$tz = new DateTimeZone('Asia/Kolkata'); ?>
            ...
            <?php 
                ...
                @endif At {{$activity->created_at}} {{$activity->activity}}</h5>
