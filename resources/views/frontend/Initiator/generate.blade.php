                    ...
                    <div class="container-fluid">
                        <div class="collapse navbar-collapse show" id="navbarSupportedContent">
                            <ul class="navbar-nav dashboard-nav">
                                <li class="nav-item active"><a class="nav-link" href="{{route('initiator_listing')}}"> <img src="{{ asset('admin/images/back.svg')}}">Generate VQ for New Product</a></li>
                            </ul>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#save_changes_btn').click(function(e){
      ...
      var rowcollection = table.$(".dt-checkboxes:checked", {"page": "all"});
        ...
        // console.log(missingStockistDetailsItems.length);
        // console.log(missingPaymentModeItems.length);
  ...
  function init_table()
  {
      ...
      table = $("#zero_config").DataTable({
        ...
        responsive: true,
        ajax: {
            url: '/initiator/generate_vq_data',
            type: 'GET',
            data: function (d) {
