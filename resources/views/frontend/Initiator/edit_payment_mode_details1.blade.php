                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td style="text-align: right">{{round($item->mrp_margin,2)}}</td>
                                            ...
                                            <td>
                                                <select name="payment_mode" class="payment_mode" class="form-control form-control-sm" <?php echo $item->new == 0 ? 'disabled="disabled"' : '';?> onchange="singlePayModeChangeHandler($(this), <?= $item->ptr ?>, <?= $item->discount_percent ?>)">
                                            ...
                                            <td class="net_discount_percent">{{ $item->net_discount_percent }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                              </table>
...
<script>
    ...
    function singlePayModeChangeHandler(e, ptr, inputDiscRate){
        ...
        let inputMargin = 10;
        console.log(inputDiscRate,'inputDiscRate');
...
<script>
    $(document).ready(function () {
        // Function to validate payment mode and net discount before saving changes
        function validateChanges() {
            ...
            $("#zero_config tbody tr").each(function () {
                ...
                let netDiscountPercent = parseFloat($(this).find(".net_discount_percent").text());
 
                // Add your validation conditions here
                if (!paymentMode || !netDiscountPercent) {
                    alert("Payment mode and net discount cannot be empty. Please fill in all required fields.");
                    isValid = false;
                    return false; // Break out of the loop if validation fails for any row
                }
            });
        ...
        $("#save_changes_btn").click(function () {
            // Call the validation function before proceeding with saving changes
            if (validateChanges()) {
                // Continue with the save changes logic here
                // ...
