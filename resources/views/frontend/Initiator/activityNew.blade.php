      ...
      <div class="collapse navbar-collapse show" id="navbarSupportedContent">
        <ul class="navbar-nav dashboard-nav">
          <li class="nav-item active">
            <li class="nav-item active"><a class="nav-link" href="{{route('initiator_listing')}}"> <img src="{{ asset('admin/images/back.svg')}}"> Activity Tracker</a></li>
          </li>
        </ul>
    ...
    <div class="row">
      ...
      <div class="col">
        <div class="actions-dashboard">
          ...
          <div class="row">
            ...
            <div class="col-md-5 filter_section  float-right">
            ...
            <div class="col-md-1  float-right mt-3" style="margin-left: -2rem">
              <a class="btn orange-btn filter_option" href="javascript:void(0)" id="">View</a>
            </div>
          </div>
          <div class="activity-tracker">
            ...
            <button id="loadMore" class="orange-btn-bor" style="display: none">VIEW MORE</button>
        </div>
      ...
      <script type="text/javascript">
        ...
        $('.filter_option').on('click', function(){
          ...
          var settings = {
            "url": "/initiator/activity_filter_new",
            "method": "POST",
            "timeout": 0,
            "headers": {
          ...
          $.ajax(settings).done(function (response) {
            ...
            if(response.status == true)
            {
              ...
              $.each(response.data, function(index, activity) {
                var activityDate = new Date(activity.activity_tracker_created_at); // modifiy line created_at to activity_tracker_created_at 07/02/2025
