...
<div id="page-content-wrapper">
      ...
      <div class="container-fluid">
          <div class="collapse navbar-collapse show" id="navbarSupportedContent">
              <ul class="navbar-nav dashboard-nav">
                  <li class="nav-item active"><a class="nav-link" href="{{route('initiator-max-discount-cap-list')}}"> <img src="../../admin/images/back.svg">Max Discount Cap - Edit Max Discount For Division</a></li>
              </ul>
  ...
  <ul class="bradecram-menu">
      ...
      <li class="active">
        <a href="">
         Edit Max Discount Cap For Division
        </a>
      </li>
  </ul>
  <div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <form class="form-horizontal" method="post" action="{{route('initiator-max-discount-cap-update')}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="max_discount" name="max_discount" placeholder="Max Discount" value="{{$data['max_discount']}}" onkeypress="if(this.value.length==5) return false;">
                    </div>
                    </div>
                ...
                <div class="border-top">
                    ...
                    <a href="{{ route('initiator-max-discount-cap-list') }}" class="btn btn-warning">Cancel</a>
                    </div>
                </div>
            </form>
