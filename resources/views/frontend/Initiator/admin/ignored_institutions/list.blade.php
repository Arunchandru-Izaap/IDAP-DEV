      ...
      <div class="container-fluid">
          <div class="collapse navbar-collapse show" id="navbarSupportedContent">
              <ul class="navbar-nav dashboard-nav">
                  <li class="nav-item active"><a class="nav-link" href="{{route('initiator_dashboard')}}"> <img src="../../admin/images/back.svg">Ignored Institutions Master</a></li>
              </ul>
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="col-md-12 d-flex ">
          <a class="orange-btn-bor" href="{{url('/initiator/ignored-institutions')}}">Add Ignored Institutions</a>
        </div>
          ...
          >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{url('initiator/ignored-institutions-edit',['id'=>$item->id])}}" class="btn btn-primary btn-sm">Edit</a><a onclick="deleteInstitutionHandler(<?= $item->id?>)" class="btn btn-danger btn-sm text-white">Delete</a>
                </td>
              </tr>
              @endforeach
            </tbody>
...
<script>
  function deleteInstitutionHandler(id){
    ...
    if(del){
      document.location.href = '/initiator/ignored-institutions-delete/'+id;
    }
  }
