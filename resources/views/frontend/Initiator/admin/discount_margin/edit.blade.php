      ...
      <div class="container-fluid">
          <div class="collapse navbar-collapse show" id="navbarSupportedContent">
              <ul class="navbar-nav dashboard-nav">
                  <li class="nav-item active"><a class="nav-link" href="{{route('initiator-discount-margin-list')}}"> <img src="../../admin/images/back.svg">Discount Margin Master - Edit Discount Margin Master</a></li>
              </ul>
  ...
  <div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <form class="form-horizontal" method="post" action="{{route('initiator-discount-margin-update')}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control text_input" id="discount_margin" name="discount_margin" placeholder="Disc Margin %" maxlength="20" value={{$data['discount_margin']}}>
                    </div>
                    </div>
                ...
                <div class="border-top">
                    ...
                    <a href="{{ route('initiator-discount-margin-list') }}" class="btn btn-warning">Cancel</a>
                    </div>
                </div>
            </form>
