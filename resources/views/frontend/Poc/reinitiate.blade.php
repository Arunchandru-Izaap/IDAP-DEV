...
function enableBtn() {
//   btn.prop("disabled", table01.find("input:checked").length === 0)
  btn.prop("disabled", table01.find("tr.selected input:checked").length === 0)
}

table01.on("change", "input", enableBtn);
enableBtn();
