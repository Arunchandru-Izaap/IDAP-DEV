                    ...
                    <div class="container-fluid">
                        <div class="collapse navbar-collapse show" id="navbarSupportedContent">
                            <ul class="navbar-nav dashboard-nav">
                                <li class="nav-item active"><a class="nav-link" href="{{route('poc_listing')}}"> <img src="{{ asset('admin/images/back.svg')}}">{{$data['vq_data']['hospital_name']}} - VQ Request Details</a></li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        @endphp
                            <div class="col-md-12 d-flex send-quotation">
                                <a href="{{url('poc/modify_stockist',$data['vq_data']['institution_id'])}}" id="approve" class="orange-btn-bor">
                                MODIFY STOCKIST
                                </a>


                            <div class="cancel-btn ml-auto">
                            <a href="{{url('poc/activity',$data['vq_data']['id'])}}" class="btn-grey border-0 m-0 p-0" data-title="View Activity">
                                ...
                                <a href="{{route('cover-letter-pdf-poc',$data['vq_data']['id'])}}" id="cover-letter" class="btn-grey">
                                <img src="{{ asset('admin/images/download.svg') }}">
                                <p>Cover Letter</p>
                                </a>
                                <a href="{{route('price-sheet-poc',$data['vq_data']['id'])}}" id="price-sheet" class="btn-grey">
                                <img src="{{ asset('admin/images/download.svg') }}">
                                <p>Price Sheet</p>
                                </a>
                                <a href="{{url('poc/view_poc',$data['vq_data']['id'])}}" class="orange-btn">
                                Send Quotation
                                </a>
                            </div>
                        </div>
 					...
 					<th class="digitcenter">L. Y. MRP</th>
                                    ...
                                    <tbody>
                                      <?php 
                                      // echo '<pre>';
                                      // print_r($data['DiscountMargin_datas']);die;
                                      ?>
                                        ...
                                        <tr>
                                            ...
                                            $item_code_disc_mrg = $item->item_code;


                                            if($data['DiscountMargin_datas']){
                                              if (array_key_exists($item_code_disc_mrg, $data['DiscountMargin_datas'])) {
                                                $inputMargin = ($data['DiscountMargin_datas'][$item_code_disc_mrg])? $data['DiscountMargin_datas'][$item_code_disc_mrg] : 10;
                                              } else {
                                                $inputMargin = 10; 
                                              }
                                            } else {
                                           ...
                                           $inputMargin = ($item->discount_margin == NULL || $item->discount_margin == '')? 10 : $item->discount_margin; 
