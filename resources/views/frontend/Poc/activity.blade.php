...
<div id="page-content-wrapper">
  ...
  <ul class="bradecram-menu">
    <li>
      <a href="{{url('poc/dashboard')}}"> Home </a>
    </li>
    <li>
      <a href="{{url('poc/listing')}}"> VQ Request Listing </a>
    </li>
    <li>
      <a href="{{url('poc/listing',$vq->id)}}"> VQ Request Details </a>
    </li>
    <li class="">
      <a href="{{url('poc/listing',$vq->id)}}">
        {{$vq->hospital_name}}
      </a>
    </li>	
	<li class="active">
