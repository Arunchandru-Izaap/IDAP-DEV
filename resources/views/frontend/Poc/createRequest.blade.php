...
<div id="page-content-wrapper">
                                ...
                                <div class="create-new-request">
                                    ...
                                    <div id="sectionvq" class="vq targetDiv">
                                        ...
                                        <form id="frminvet" class="fromdate">
                                          ...
                                          <div class="w-100">
                                            <button class="orange-btn d-none" id="initiate">INITIATE VQ REQUEST</button>
                                          </div>
                                        </form>

                                        <form id="frmreinit" class="fromdate formadd m-3" method="POST" action="{{url('initiator/reinitiate','all')}}" style="border:orange; border-width:1px; border-style:solid; border-radius: 5px; padding: 20px">
                                          @csrf()
                                          ...
                                          <fieldset>
                                            ...
                                            <div class="p-3 form-check-inline" id="select_approval_form" style="border:orange; border-width:1px; border-style:solid; border-radius: 5px; padding: 20px">
                                              <div class="px-3">
                                                <div>
                                                  <input type="checkbox" name="select_approval[]" value="1" id="level_1"><label for="level_1">Level 1</label>
                                                </div>
                                                <div>
                                                  <input type="checkbox" name="select_approval[]" value="2" id="level_2"><label for="level_2">Level 2</label>
                                                </div>
                                              ...
                                              <div class="px-3">
                                                <div>
                                                  <input type="checkbox" name="select_approval[]" value="3" id="level_3"><label for="level_3">Level 3</label>
                                                </div>
                                                <div>
                                                  <input type="checkbox" name="select_approval[]" value="4" id="level_4"><label for="level_4">Level 4</label>
                                                </div>
                                              </div>
                                              ...
                                              <div class="px-3">
                                                ...
                                                <div>
                                                  <input type="checkbox" name="select_approval[]" value="5" id="level_5"><label for="level_5">Level 5</label>
                                                </div>
                                                <div>
                                                  <input type="checkbox" name="select_approval[]" value="6" id="level_6"><label for="level_6">Level 6</label>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="start-end-date">
                                                <div class="input-group">
                                                    <select name="institutes[]" id="institute_drop" multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="3" onchange="console.log(this.selectedOptions)">
                                        ...
                                        <form id="frmaddpack" class="fromdate formadd m-3" style="border:orange; border-width:1px; border-style:solid; border-radius: 5px; padding: 20px">
                                        ...
                                        <form id="frmaddcounter" class="fromdate formadd m-3" style="border:orange; border-width:1px; border-style:solid; border-radius: 5px; padding: 20px">
        ...
        $('#new_institutes_drop').on('change', function(){
        ...
        // $('#new_counter_startdate').on('change', function(){
          
        // })

        // $('#new_counter_enddate').on('change', function(){
        ...
        $('#add_new_counter_btn').click(function(e){
          ...
          var settings = {
            ...
            "from": $("#new_counter_startdate").val(),
            "to": $("#new_counter_enddate").val(),
            }
          };
          $.ajax(settings).done(function (response) {
            if(response.success){
