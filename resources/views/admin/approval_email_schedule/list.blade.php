    ...
    <div class="row">
        ...
        <div class="card">
                ...
                <div class="col-md-12 d-flex ">
                  <h5 class="card-title me-3"><a href="{{url('/admin/approval-email-schedule')}}">Add approval email schedule</a></h5>
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{url('admin/approval-email-schedule-edit',['id'=>$item->id])}}" class="btn btn-primary btn-sm">Edit</a>
...
<script>
  ...
  function deleteInstitutionHandler(id){
    ...
    if(del){
      document.location.href = '/admin/approval-email-schedule-delete/'+id;
    }
  }
