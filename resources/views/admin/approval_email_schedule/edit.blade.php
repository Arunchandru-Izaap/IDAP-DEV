...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <form class="form-horizontal" method="post" action="{{route('approval-email-schedule-update')}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row date_section">
                      ...
                      <div class="col-sm-4">
                          <input type="text" class="form-control" id="start_date" name="start_date" placeholder="Start Date" value="{{ isset($dmdata['start_date']) ? \Carbon\Carbon::parse($dmdata['start_date'])->format('d M Y') : '' }}">
                      </div>
                    </div>
                    <div class="form-group row date_section">
                      <label for="lname" class="col-sm-3 text-end control-label col-form-label">End Date</label>
                      <div class="col-sm-4">
                          <input type="text" class="form-control" id="end_date" name="end_date" placeholder="End Date" value="{{ isset($dmdata['end_date']) ? \Carbon\Carbon::parse($dmdata['end_date'])->format('d M Y') : '' }}">
                      </div>
                    </div>
                    <div class="form-group row">
