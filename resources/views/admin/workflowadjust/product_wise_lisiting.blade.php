        ...
        <div class="card-body">
          <div class="row mb-2">
            <div class="col-md-2 mr-20">
                ...
                <select id="brand_name" class="js-example-basic-multiple" name="brand_name" multiple data-placeholder="Select Brands">
                    <option value=''> Select </option>
                    @foreach($data['brand_details'] as $brands)
                    <option value="{{$brands->item_code}}">{{$brands->item_code}} - {{$brands->brand_name}}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-2 mr-20">
                ...
                <select name="approver_level" id="approver_level" class="form-control">
                    ...
                    <option value="1" class="poc-hidden">RSM</option>
                    <option value="2" class="poc-hidden">ZSM</option>
                    <option value="3" class="poc-hidden">NSM</option>
                    ...
                    <table class="table table-striped table-bordered" id="zero_config_admin">
                        <thead>
                            <tr>
                                ...
                                <th class="" style="width: 110px !important">institution ID</th>
                                <th class="" style="width: 90px !important">Division</th>
                                <th class="" style="width: 110px !important">Disc PTR(%)</th>
                                <th class="" style="width: 90px !important">RTH (Excel. GST)</th>
                                <th class="" style="width: 90px !important">Mother Brand</th>
                                <th class="" style="width: 90px !important">Item Code</th>
                                <th class="" style="width: 90px !important">Brand Name</th>
  ...
  <div class="modal-dialog modal-dialog-centered model-pop-ct">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <a class="btn btn-warning" href="" id="">Close</a>
      </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.view-data').on('click',function(){
                ...
                if($('#approver_level').val() == '')
                {
                    alert('Please select any one Approver Level')
                    return;
                }
                init_table()
            ...
            $('.action_btn').click(function(e){
                ...
                if(userConfirmed) {
                    ...
                    if(rsmLevel.length == 0 && initatorLevel.length == 0&& ceoLevel.length == 0) {
                        ...
                        var settings = {
                            "url": "/admin/workflow_adjust_forward_backward_levels",
                            "method": "POST",
                            "timeout": 0,
                            "headers": {
                            ...
                            "selected_brandname": $('#brand_name').val(),
                            "selected_approver_level": $('#approver_level').val(),
                            "action":btn_type
                            })
                        };
        ...
        function init_table()
        {
            ...
            table = $("#zero_config_admin").DataTable({
                ...
                responsive: true,
                ajax: {
                    url: '/admin/get_pending_vq_data_workflow_product_wise',
                    type: 'GET',
                    data: function (d) {
                    // Add custom data to the request
                        d.brand_name = $('#brand_name').val();
                        d.approver_level = $('#approver_level').val();
                        return d;
                    },
                ...
                { data: 'div_name' },//2
                { data: 'discount_percent' },//3
                { data: 'discount_rate' },//4
                { data: 'mother_brand_name' },//5
                { data: 'item_code' },//6
                { data: 'brand_name' },//7
                { data: 'rev_no' },//8
                { data: 'sap_code' },//9
                ...
                {
                    targets: 10, 
                    className: 'current_level text-center', 
                }, 
                {
                    targets: 11, 
