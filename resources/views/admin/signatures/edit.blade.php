...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        ...
        <form class="form-horizontal" method="post" action="{{route('signature-update')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="col-sm-9">
                        <input type="file" class="form-control" id="spll_sign" name="spll_sign" value="{{ asset('/images/') }}/{{$data->spll_sign}}">
                    </div>
                    </div>
                    <div class="form-group row">
                    <label for="lname" class="col-sm-3 text-end control-label col-form-label">Spli Sign</label>
                    <div class="col-sm-9">
                    <input type="file" class="form-control" id="spil_sign" name="spil_sign" value="{{ asset('/images/') }}/{{$data->spil_sign}}">
                    </div>
                    </div>
