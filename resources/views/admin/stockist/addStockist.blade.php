...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" method="post" action="{{route('stockist-store')}}">
                @csrf
            <div class="card-body">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="stockist_name" name="stockist_name" placeholder="Stockist name">
                </div>
                </div>
                <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="stockist_type_flag" name="stockist_type_flag" placeholder="Stockist type flag">
                </div>
                </div> 
            </div>
