...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" method="post" action="{{route('last-year-price-store')}}">
                @csrf
            <div class="card-body">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="sku_id" name="sku_id" placeholder="Sku name">
                </div>
                </div>
                <div class="form-group row">
                <label for="lname" class="col-sm-3 text-end control-label col-form-label">Institution name</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="institution_id" name="institution_id" placeholder="Institution name">
                </div>
                </div>
                <div class="form-group row">
                <label for="lname" class="col-sm-3 text-end control-label col-form-label">Division name</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="division_id" name="division_id" placeholder="Division name">
                </div>
                </div>
                <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="discount_rate" name="discount_rate" placeholder="Discount Rate">
                </div>
                </div>
