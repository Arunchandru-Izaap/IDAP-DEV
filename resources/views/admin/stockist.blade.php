...
table.dataTable tbody>tr.selected, table.dataTable tbody>tr>.selected {
  ...
  .dataTables_paginate .paginate_button.disabled {
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 send-quotation">
                <div class="cancel-btn float-end">
                  <button class="btn btn-primary action_btn mr-2" id="view_log" btn-fn="view_log">View Log</button>
                </div>
            </div>
            ...
            <div class="col mt-2">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <button class="nav-link active" id="btn-institution-wise"  data-bs-toggle="tab" data-bs-target="#intutionwise" role="tab" aria-controls="intutionwise" aria-selected="true" >Institution Wise</a></button>
                    </li>
                    <li class="nav-item">
                       <button class="nav-link " id="btn-stockist-wise" data-bs-toggle="tab" data-bs-target="#stockistwise" role="tab" aria-controls="stockistwise" aria-selected="false">Stockist Wise</button>
                    </li>  
                </ul>
                             ...
                             <div class="container">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row" id="serviceflags" style='display:none;'>
                                        ...
                                        <input type="checkbox" id="stockist_type_flag" class="">
      ...
      <div class="modal-dialog modal-dialog-centered model-pop-ct">
        <div class="modal-content">
          ...
          <div class="modal-header border-0">
              <div class="tich-logo">
              <img style="width: 25px;" src="{{ asset('admin/images/ticket.svg') }}">
              </div>
          </div>
          <!-- Modal body -->
          <div class="modal-body">
            <p class="text-center">Updation successfully done</p>
            <a class="btn btn-warning btn-sm" href="{{route('home')}}" id="">Home</a>
            <a class="btn btn-warning btn-sm" href="javascript:void(0)" id="" data-bs-dismiss="modal">Close</a>
          </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg modal-custom-position" style="max-width: 1000px;">
          <div class="modal-content">
            ...
            <div class="modal-header border-0">
              ...
              <button type="button" class="d-none close" data-bs-dismiss="modal">
    ...
    <div class="modal show" id="view_institutionwise_modal">
        <div class="modal-dialog modal-dialog-centered modal-lg modal-custom-position" style="max-width: 1200px;">
          <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header border-0">
                <div class="tich-logo">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#downlaod').click(function() {
            ...
            $('#downlaod').prop('href', '/admin/download_institution/' + stockist_master_id)
            // Disable the button and show loading indication
            //$(this).prop('disabled', true).text('Loading...');
            

            /*$.ajax({
                url: '/admin/ajax/stockists/' + institutionId,
                type: 'PUT',
                data: {
                ...
                success: function(response) {
                    $('#downlaod').prop('href', './admin/download/' + institutionId)
        ...
        $('#stockist').on('change', function() {
            ...
            if(stockistId != '')
            {
                ...
                if (stockistId) {
                    $.ajax({
                        url: '/admin/ajax/payment/' + stockistId,
                        type: 'GET',
        ...
        $('#stockistss').on('change', function() {
            ...
            {
                $('#savestockist').show();
                $('#downlaods').prop('href', '/admin/download_stockist/'+stockistId)
                $('#loader1').show();
                if (stockistId) {
                    $.ajax({
                        url: '/admin/ajax/payment/' + stockistId,
        ...
        $('#updateStockistForms').on('submit', function(e) {
            ...
            $('#loader1').show();
            $.ajax({
                url: '/admin/stockists/' + stockistCode,
                type: 'PUT',
                data: {
        ...
        $('#updateStockistForm').on('submit', function(e) {
            ...
            if(stockist_master_id !== '' && stockistType !== '' && payment_mode !== '')
            {
                $('#loader1').show();
                var settings = {
                    "url": "/admin/stockist_update_institution",
                    "method": "POST",
                    "timeout": 0,
                    "headers": {
        ...
        $('#zero_config1_length select').addClass('form-control form-control-sm')
        $('#zero_config1_filter input').addClass('form-control form-control-sm')
        $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
            var tableId = settings.nTable.getAttribute('id');
            if (tableId !== 'zero_config_admin') {
