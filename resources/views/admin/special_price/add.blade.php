...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" method="post" action="{{route('special-price-store')}}">
                @csrf
            <div class="card-body">
                ...
                <div class="form-group row">
                <label for="lname" class="col-sm-3 text-end control-label col-form-label">Discount rate</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control"  name="discount_rate" placeholder="Discount rate">
                </div>
                </div> 
            </div>
