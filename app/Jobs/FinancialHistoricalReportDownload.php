...
class FinancialHistoricalReportDownload implements ShouldQueue
{
    ...
    $zip_file = 'public/financialyearhistoricalreport'.$this->emp_code. '-'.$year.'.zip'; // Name of our archive to download
    ...
    function regionGenerator($year,$zip,$region) {
        ...
        $sheet->setCellValue('A1', 'IDAP - Financial Year Historical Report');
        ...
        $sheet->getStyle('A3:X3')->applyFromArray($headingStyleArray);
        $sheet->removeRow(4);
