...
class InitiatorExport implements FromCollection,WithDrawings,WithHeadings,WithStyles,WithColumnWidths,WithEvents
{
    ...
    */
    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getColumnDimension('B')->setWidth(37);
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->fromArray([], null, 'D6', false, false)
        ->getStyle('D6')
        ->getAlignment()
        ->setWrapText(true);

        $sheet->fromArray([], null, 'I6', false, false)
        ->getStyle('I6')
        ->getAlignment()
        ->setWrapText(true);
        ...
        $sheet->getStyle('G2')->getFont()->setSize(12);
    ...
    public function collection()
    {
        ...
        // return $data;
        return VoluntaryQuotationSkuListing::leftJoin('employee_master','employee_master.div_code','=','voluntary_quotation_sku_listing.div_id')->select('voluntary_quotation_sku_listing.item_code',
